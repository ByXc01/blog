...
测试程序启动了十个线程并调用add_task函数加入了4000个任务，add_task支持普通全局函数、静态函数、类成员函数、函数对象（仿函数）以及lambda表达式，并且支持函数传入，该线程池的实现以及测试代码我已经放到了[github][4]上。
...
《深入应用C++11--代码优化与工程级应用》
  ...
  [4]: https://github.com/chxuan/samples/tree/master/thread_pool
